...
function App() {
  ...
  const run = () => {
    ...
    if (res[0]) {
      setResult(`Yaaaay 🤩🤩!!! your birthdate is a palindrome 👉 ${result[2][result[3]]} 👈`);
    } else {
      ...
      if (prevDate < nextDate) {
        setResult(`Wooops! Your birthdate is not a palindrome, the nearest palindrome date is ${otherwise[0]} and you missed it by just ${prevDate}`);
      } else {
        setResult(`Wooops! Your birthdate is not a palindrome, the nearest palindrome date is ${otherwise[1]} and you missed it by just ${nextDate} days`);
      }
    }
    ...
    <div className="app">
      <div className="main_container">
        ...
        <div className="result">
          <div class="loader-div"><div class="loader1">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
